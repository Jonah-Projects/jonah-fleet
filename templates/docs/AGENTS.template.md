...
- **Fleet Run Footer & Badge**: Every GitHub comment, issue edit, and PR description posted by automated Actions must end with the unified Fleet footer and run badge:
  ```markdown
