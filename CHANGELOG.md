...
* **daemon:** filter out PRs with pending CI from review queue to avoid premature dispatch ([6344a8e](https://github.com/Jonah-Projects/jonah-fleet/commit/6344a8eeed1c3b992aa7004d51e92fa7cbd665b7))
...
* **guard:** exempt analytics-review from repetition and ping-pong loop circuit breakers ([#447](https://github.com/Jonah-Projects/jonah-fleet/issues/447)) ([#450](https://github.com/Jonah-Projects/jonah-fleet/issues/450)) ([839873c](https://github.com/Jonah-Projects/jonah-fleet/commit/839873c1c9e40b633a3e52a77aa74fc66374b8df))
...
* **runner:** preserve uncommitted work on crash and enforce incremental commits ([da58b83](https://github.com/Jonah-Projects/jonah-fleet/commit/da58b83334df971778417142520b321f7b520d5b))

## [1.27.2](https://github.com/Jonah-Projects/jonah-fleet/compare/v1.27.1...v1.27.2) (2026-09-24)


### Bug Fixes

* **daemon:** classify draft PRs needing convergence as actionable ([#430](https://github.com/Jonah-Projects/jonah-fleet/issues/430)) ([4d407fb](https://github.com/Jonah-Projects/jonah-fleet/commit/4d407fbb34ac8853b512094b5078bc9b8c1b9f53))
...
* **ci:** allow graceful fallback if GitHub App token creation fails ([f9629a6](https://github.com/Jonah-Projects/jonah-fleet/commit/f9629a624b6ec888a480d46be866898e88d35d35))
...
* **guard:** exempt replace_file_content and write_to_file from repetition and ping-pong circuit breakers
...
* **guard:** exempt view_file and read_file from repetition circuit breaker ([#382](https://github.com/juliendurandeu/jonah-fleet/issues/382)) ([bc04e90](https://github.com/juliendurandeu/jonah-fleet/commit/bc04e90fe9d59de0e30f7d2ff36a202d2588d4f0))

## [1.25.1](https://github.com/juliendurandeu/jonah-fleet/compare/v1.25.0...v1.25.1) (2026-09-23)


### Bug Fixes

* **radar:** calibrate upstream heuristics to eliminate false positive Category A and B alerts ([5a4ebfe](https://github.com/juliendurandeu/jonah-fleet/commit/5a4ebfe8588867ef0ff3aacab8ad6b6162cc5636))
...
* **guard:** exempt manage_subagents list polling and prevent busy-waiting on unchanged files ([#319](https://github.com/juliendurandeu/jonah-fleet/issues/319)) ([7a7168f](https://github.com/juliendurandeu/jonah-fleet/commit/7a7168f51c670e62efb15c210def8ca8df282161))

## [1.22.0](https://github.com/juliendurandeu/jonah-fleet/compare/v1.21.0...v1.22.0) (2026-09-20)


### Features

* **orchestration:** adopt Chief of Staff verification and Red Gate discipline ([#308](https://github.com/juliendurandeu/jonah-fleet/issues/308)) ([7e669de](https://github.com/juliendurandeu/jonah-fleet/commit/7e669de7e56a0fbe0feb0f694b2d29439416b421))
...
* **autowork:** add opportunistic operational log sweep (idle GC) to Step 9 ([#285](https://github.com/juliendurandeu/jonah-fleet/issues/285)) ([8e4cf12](https://github.com/juliendurandeu/jonah-fleet/commit/8e4cf122cb949bdc23bdc3eaa1f80e4a7739dde6))
